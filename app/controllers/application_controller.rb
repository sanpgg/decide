...
class ApplicationController < ActionController::Base
  ...
  private
    ...
    #  unless current_user.residence_verified?
       #redirect_to new_address_user_path, alert: t('verification.residence.alert.unconfirmed_residency')
    #  end
    end

    def verify_verified!
      if current_user.level_two_or_three_verified? && current_user.curp?
        #redirect_to(new_address_user_path, notice: t('a'))
      end
    end
